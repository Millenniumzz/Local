    ...
    return (
        <div style={{margin:'30px'}}>
            <form ref={form} onSubmit={onSubmitForm}>   
                <div>ติดต่อ</div>
                <input style={inputStyle} type="text" name="name" size="43" placeholder="ชื่อ-สกุล" /><br/>
                <input style={inputStyle} type="email" name="email" size="43" placeholder="อีเมล" /><br/>
                <textarea style={inputStyle} name="message" cols="40" rows="4" placeholder="ข้อความ" /><br/>
